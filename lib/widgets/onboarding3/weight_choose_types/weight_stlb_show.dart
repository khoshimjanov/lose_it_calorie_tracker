...
class WeightStLbWidget extends StatefulWidget {
  const WeightStLbWidget({super.key});
...
class _WeightStLbWidgetState extends State<WeightStLbWidget> {
              ...
              Provider.of<RegisterForm>(context, listen: false).addPersonWeight(
                  Weight(
                      lbWeight: convertStonePoundsToLb(
                          _st, double.parse('$_stLb.$_stLbDouble'),),
                      stLbWeight: StLb(
                          stone: _st, lb: double.parse('$_stLb.$_stLbDouble'),),
            ...
            setState(() {
              ...
              Provider.of<RegisterForm>(context, listen: false)
                  .addPersonaimWeight(Weight(
                      lbWeight: convertStonePoundsToLb(
                          _aimst, double.parse('$_aimstLb.$_aimstLbDouble'),),
                      stLbWeight: StLb(
                          stone: _aimst,
  ...
  Widget build(BuildContext context) {
    ...
    return WeightInput(
      ...
      aimWeightValueChanged: _showaimStLbWeightPicker,
      ...
      aimWeightText: person.aimweight?.stLbWeight == null
